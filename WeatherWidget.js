...
class WeatherWidget extends Component {
  ...
  componentDidMount() {
    ...
    return fetch('https://api.darksky.net/forecast/' + this.props.api + '/' + this.props.lat + ',' + this.props.lng + '?lang=' + this.props.lang).then((response) => response.json()).then((responseJson) => {
